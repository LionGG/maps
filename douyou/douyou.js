...
function init() {
    ...
    //var userid = T.string.trim(idInput.value);
...
function drawChart() {
    ...
    var chart = new google.visualization.PieChart(T.g('chartDiv'));
...
//文字统计
function drawInfo(proData, numMax) {
    var str = [], sum = 0, length = 0;
    T.object.each(proData, function (value, key) {
